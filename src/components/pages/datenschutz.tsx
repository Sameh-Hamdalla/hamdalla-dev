  ...
  return (
    <main className="legal-page">
      <section className="legal-hero">
        ...
        <p>
          Hier finden Sie alle wichtigen Informationen zum Umgang mit
      ...
      <section className="legal-content">
        ...
        <article className="legal-section">
          <h2>3. Hosting</h2>
          <p>Unsere Website wird bei folgenden Anbietern gehostet:</p>
          <ul>
          ...
          <p>Die Verarbeitung erfolgt zur Bereitstellung und Sicherheit der Website.</p>
        ...
        <article className="legal-section">
          ...
          <p>Eine Einwilligung ist hierfür nicht erforderlich.</p>
        </article>

        <article className="legal-section">
          <h2>7. Social Media Links</h2>
          <p>Auf unserer Website befinden sich Links zu unseren Profilen bei sozialen Netzwerken:</p>
          <ul>
            <li>Instagram (Meta Platforms Ireland Limited)</li>
            <li>LinkedIn (LinkedIn Ireland Unlimited Company)</li>
          </ul>
          <p>
            Beim Anklicken eines solchen Links werden Sie auf die jeweilige
            Plattform weitergeleitet. Es erfolgt keine automatische
        ...
        <article className="legal-section">
          ...
          <p>
            Unsere Website enthält Links zu externen Seiten. Für deren Inhalte
            und Datenschutz sind die jeweiligen Betreiber verantwortlich.
          </p>
        </article>
